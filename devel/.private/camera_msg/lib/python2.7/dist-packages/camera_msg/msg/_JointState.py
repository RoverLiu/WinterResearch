...
"""autogenerated by genpy from camera_msg/JointState.msg. Do not edit."""
import codecs
import sys
...
class JointState(genpy.Message):
  _md5sum = "73808776ee8064d08af80cf01bcc1b74"
  _type = "camera_msg/JointState"
...
"""
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.left = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.right = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
